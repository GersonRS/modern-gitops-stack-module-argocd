...
module "argocd_bootstrap" {
  ...
  # Optional: Configure repositories to be added to Argo CD
  ssh_private_key = var.ssh_private_key
  repositories = [
    "git@github.com:example/infrastructure.git",
    "git@github.com:example/applications.git"
  ]
  
  # Optional: Configure AppProjects
  argocd_projects = {
    "default" = {
...
- https://registry.terraform.io/providers/argoproj-labs/argocd/latest/docs/resources/project[argocd_project.modern_gitops_stack_applications] (resource)
- https://registry.terraform.io/providers/argoproj-labs/argocd/latest/docs/resources/repository[argocd_repository.private] (resource)
...
Description: List of Git repository URLs to be added to Argo CD. These repositories will be configured   
...
|[[output_argocd_namespace]] <<output_argocd_namespace,argocd_namespace>> |The namespace where Argo CD resides. The main use of this output is to create an implicit dependency when passing this attribute to the argoproj-labs/argocd provider settings.
